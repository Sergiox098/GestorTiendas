...
public class ProductEditVM extends ViewModel {
    ...
    public void EditObject(String uid, String oldName, String name, String ref, String description, String price,
                             String category, String brand, String stock, String weight, String supplier,
                             String contact, Uri imageUri, String oldImage, String selectedStore) {
        ...
        if (imageUri != null) {
            ...
            StorageReference imageOldRef = firebaseStorage.getReference()
                    .child("Users").child(uid).child("Stores").
                    child(selectedStore).child("Products").child(oldName).child("product_image.jpg");
            ...
            ProductModel productData = new ProductModel(name, ref, description, price,
                    category, brand, stock, weight, supplier, contact);
            productData.setImageUrl(oldImage);
            productsRef.setValue(productData).addOnCompleteListener(task -> {
                isLoading.setValue(false);
                if (task.isSuccessful()) {
                    registerSuccess.setValue(true);
